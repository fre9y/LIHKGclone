...
(2, 1, null, '唱到咁樣同聿禮安比較，
其實算獻醜定爭光#', null, 1, 3),
(3, 1, 2, '唔一定要高音先叫唱得好既', null, 3, 1),
(2, 1, null, '其實只係我地自己友係度瘋狂洗view', null, 7, 2),
(4, 1, 3, '香港人真係哂鳩氣
...
一定孝順', null, 13, 1),
(3, 2, null, '胡錦濤', null, 9, 1),
(1, 2, 1, '胡家寶藏', null, 2, 11),
(2, 2, null, '力威', null, 1, 23),
(4, 2, 4, '唔練下身', 4, 0, 1),
...
(2, 3, 8, '外賣唔送自求多福', null, 0, 1),
(4, 3, 7, '都40年樓, 真係好咩', null, 3, 2),
(3, 3, 9, '與其買第一城咁舊嘅樓不如俾貴少少買啲同區新啲嘅樓，舊樓遲早無人買只會一路眨值', null, 0, 0),
(1, 3, null, '你就唔送', 2, 0, 0),
...
蒙面法正式實施', null, 8, 24),
(3, 4, null, '都會繼續戴', null, 0, 1),
(2, 4, null, '除罩撚歡呼鳥', null, 4, 3),
(1, 4, null, '無口罩令帶口罩係咪告暴動🤣🤣🤣', null, 0, 0),
...
(1, 5, 3, 'lm', null, 5, 5),
(3, 5, 7, 'lm', null, 6, 1),
(4, 5, null, '建議新嘅金剛棒update返欠債alex柒事', null, 3, 4);
